...
export class WebAppPanel {
    ...
    public static screenshotRequestHandler: (() => Promise<{ width: number, height: number, bpp: number, data: string }>) | null = null;
            ...
            async message => {
                switch (message.command) {
                    ...
                    case 'requestScreenshot':
                        if (WebAppPanel.screenshotRequestHandler) {
                            try {
                                const result = await WebAppPanel.screenshotRequestHandler();
                                this.panel.webview.postMessage({
                                ...
                                vscode.window.showErrorMessage(`Failed to get screenshot: ${err}`);
                            }
                        }
                        return;
                }
