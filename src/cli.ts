...
function startDebugInfoServer() {
    ...
    function onConnected(sock: net.Socket) {
        ...
        console.log('[Debugger] New debugger connected: %s', remoteAddress);
        ...
        sock.on('data', function(data: string) {
            ...
            console.log('[Debugger] %s Requested: %s', remoteAddress, requestStr);
        });
        sock.on('close',  function () {
            console.log('[Debugger] Connection from %s closed', remoteAddress);
        });
    }
}
